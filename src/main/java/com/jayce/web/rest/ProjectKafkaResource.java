package com.jayce.web.rest;

import static org.springframework.web.servlet.mvc.method.annotation.SseEmitter.event;

import com.jayce.config.KafkaSseConsumer;
import com.jayce.config.KafkaSseProducer;
...
public class ProjectKafkaResource {
    ...
    public ProjectKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
